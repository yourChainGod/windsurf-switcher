...
public struct PoolConfig: Sendable, Equatable {
    ...
    /// sticky cascade 绑定 TTL
    public var stickyTTL: TimeInterval
    ...
    public init(
        ...
        self.scoreBucketSize = scoreBucketSize
    }
