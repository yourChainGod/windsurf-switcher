...
public struct Wrapper {
    ...
    public static func installBoth(relayPort: UInt16, inferencePort: UInt16) throws -> [WrapperStatus] {
        let stable = Wrapper(app: .stable, relayPort: relayPort, inferencePort: inferencePort)
        let next = Wrapper(app: .next, relayPort: relayPort, inferencePort: inferencePort)
        ...
        if !scripts.isEmpty {
            ...
            let dummy = Wrapper(app: .stable, relayPort: relayPort, inferencePort: inferencePort)
